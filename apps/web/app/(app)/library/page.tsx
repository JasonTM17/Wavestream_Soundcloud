        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {user && (
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:block text-sm font-medium text-foreground">{user.displayName}</span>
            </div>
          )}
        </div>
        ...
        {activeTab === "playlists" && (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Button type="button" onClick={() => setIsCreateOpen(true)} className="rounded-full">
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant={playlist.isPublic ? "soft" : "outline"} className="text-[10px]">
              ...
              {reports.map((report) => (
                <div key={report.id} className="rounded-lg bg-card border border-border p-4">
                  <div className="flex flex-wrap items-center gap-2">
                    <Badge variant="soft" className="text-xs">{report.reportableType}</Badge>
