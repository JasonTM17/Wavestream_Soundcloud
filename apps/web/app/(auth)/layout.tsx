      ...
      <AuthPageGuard>
        <main className="min-h-screen px-4 py-6 lg:px-6">
          <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-7xl overflow-hidden rounded-[2rem] border border-border/85 bg-card/92 shadow-[0_30px_80px_-35px_rgba(10,13,25,0.42)] backdrop-blur-xl lg:grid-cols-[0.92fr_1.08fr]">
            <section className="hidden flex-col gap-8 bg-[radial-gradient(circle_at_top,_rgba(38,189,255,0.18),transparent_32%),radial-gradient(circle_at_bottom_right,_rgba(239,197,90,0.14),transparent_30%),linear-gradient(180deg,rgba(7,11,24,0.97),rgba(14,22,40,0.92))] p-8 text-white lg:flex">
              <div className="flex items-center justify-between gap-4">
                ...
                <ThemeToggle className="border-white/18 bg-white/10 text-white shadow-sm hover:border-white/22 hover:bg-white/16 hover:text-white" />
              </div>
              ...
              <div className="mt-2 flex flex-col gap-4">
                <div
                  ...
                  className="rounded-[1.8rem] border border-white/12 bg-white/8 p-5 shadow-[0_18px_50px_-28px_rgba(0,0,0,0.45)]"
                >
